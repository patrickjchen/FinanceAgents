...
async def list_agents():
    return {
        "available_agents": [
            "RAGAgent - Passage retrieval over internal filings (ChromaDB + HuggingFace embeddings)",
            "FinanceAgent - Internal document analysis (LLM summary over RAGAgent passages)",
